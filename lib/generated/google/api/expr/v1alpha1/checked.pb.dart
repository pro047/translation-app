...
class CheckedExpr extends $pb.GeneratedMessage {
  ...
  factory CheckedExpr.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory CheckedExpr.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CheckedExpr', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.v1alpha1'), createEmptyInstance: create)
    ...
    ..aOM<$28.Expr>(4, _omitFieldNames ? '' : 'expr', subBuilder: $28.Expr.create)
    ..aOM<$28.SourceInfo>(5, _omitFieldNames ? '' : 'sourceInfo', subBuilder: $28.SourceInfo.create)
  ...
  @$pb.TagNumber(4)
  $28.Expr get expr => $_getN(2);
  @$pb.TagNumber(4)
  set expr($28.Expr value) => $_setField(4, value);
  @$pb.TagNumber(4)
  $core.bool hasExpr() => $_has(2);
  @$pb.TagNumber(4)
  void clearExpr() => $_clearField(4);
  @$pb.TagNumber(4)
  $28.Expr ensureExpr() => $_ensure(2);

  /// The source info derived from input that generated the parsed `expr` and
  /// any optimizations made during the type-checking pass.
  @$pb.TagNumber(5)
  $28.SourceInfo get sourceInfo => $_getN(3);
  @$pb.TagNumber(5)
  set sourceInfo($28.SourceInfo value) => $_setField(5, value);
  @$pb.TagNumber(5)
  $core.bool hasSourceInfo() => $_has(3);
  @$pb.TagNumber(5)
  void clearSourceInfo() => $_clearField(5);
  @$pb.TagNumber(5)
  $28.SourceInfo ensureSourceInfo() => $_ensure(3);
...
class Type_ListType extends $pb.GeneratedMessage {
  ...
  factory Type_ListType.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Type_ListType.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class Type_MapType extends $pb.GeneratedMessage {
  ...
  factory Type_MapType.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Type_MapType.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class Type_FunctionType extends $pb.GeneratedMessage {
  ...
  factory Type_FunctionType.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Type_FunctionType.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class Type_AbstractType extends $pb.GeneratedMessage {
  ...
  factory Type_AbstractType.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Type_AbstractType.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class Type extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Type', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.v1alpha1'), createEmptyInstance: create)
    ...
    ..aOM<$19.Empty>(1, _omitFieldNames ? '' : 'dyn', subBuilder: $19.Empty.create)
    ..e<$32.NullValue>(2, _omitFieldNames ? '' : 'null', $pb.PbFieldType.OE, defaultOrMaker: $32.NullValue.NULL_VALUE, valueOf: $32.NullValue.valueOf, enumValues: $32.NullValue.values)
    ...
    ..aOM<$19.Empty>(12, _omitFieldNames ? '' : 'error', subBuilder: $19.Empty.create)
  ...
  /// Dynamic type.
  @$pb.TagNumber(1)
  $19.Empty get dyn => $_getN(0);
  @$pb.TagNumber(1)
  set dyn($19.Empty value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasDyn() => $_has(0);
  @$pb.TagNumber(1)
  void clearDyn() => $_clearField(1);
  @$pb.TagNumber(1)
  $19.Empty ensureDyn() => $_ensure(0);

  /// Null value.
  @$pb.TagNumber(2)
  $32.NullValue get null_2 => $_getN(1);
  @$pb.TagNumber(2)
  set null_2($32.NullValue value) => $_setField(2, value);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(12)
  $19.Empty get error => $_getN(11);
  @$pb.TagNumber(12)
  set error($19.Empty value) => $_setField(12, value);
  @$pb.TagNumber(12)
  $core.bool hasError() => $_has(11);
  @$pb.TagNumber(12)
  void clearError() => $_clearField(12);
  @$pb.TagNumber(12)
  $19.Empty ensureError() => $_ensure(11);
...
class Decl_IdentDecl extends $pb.GeneratedMessage {
  ...
  factory Decl_IdentDecl.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Decl_IdentDecl.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Decl.IdentDecl', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.v1alpha1'), createEmptyInstance: create)
    ...
    ..aOM<$28.Constant>(2, _omitFieldNames ? '' : 'value', subBuilder: $28.Constant.create)
  ...
  @$pb.TagNumber(2)
  $28.Constant get value => $_getN(1);
  @$pb.TagNumber(2)
  set value($28.Constant value) => $_setField(2, value);
  @$pb.TagNumber(2)
  $core.bool hasValue() => $_has(1);
  @$pb.TagNumber(2)
  void clearValue() => $_clearField(2);
  @$pb.TagNumber(2)
  $28.Constant ensureValue() => $_ensure(1);
...
class Decl_FunctionDecl_Overload extends $pb.GeneratedMessage {
  factory Decl_FunctionDecl_Overload({
    ...
    if (resultType != null) result.resultType = resultType;
    if (isInstanceFunction != null) result.isInstanceFunction = isInstanceFunction;
    if (doc != null) result.doc = doc;
    return result;
  }
  ...
  factory Decl_FunctionDecl_Overload.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Decl_FunctionDecl_Overload.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class Decl_FunctionDecl extends $pb.GeneratedMessage {
  ...
  factory Decl_FunctionDecl.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Decl_FunctionDecl.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class Decl extends $pb.GeneratedMessage {
  ...
  factory Decl.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Decl.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class Reference extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Reference', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.v1alpha1'), createEmptyInstance: create)
    ...
    ..aOM<$28.Constant>(4, _omitFieldNames ? '' : 'value', subBuilder: $28.Constant.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $28.Constant get value => $_getN(2);
  @$pb.TagNumber(4)
  set value($28.Constant value) => $_setField(4, value);
  @$pb.TagNumber(4)
  $core.bool hasValue() => $_has(2);
  @$pb.TagNumber(4)
  void clearValue() => $_clearField(4);
  @$pb.TagNumber(4)
  $28.Constant ensureValue() => $_ensure(2);
}
