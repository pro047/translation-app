...
class Key extends $pb.GeneratedMessage {
  ...
  factory Key.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Key.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Key', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.apikeys.v2'), createEmptyInstance: create)
    ...
    ..aOM<$22.Timestamp>(4, _omitFieldNames ? '' : 'createTime', subBuilder: $22.Timestamp.create)
    ..aOS(5, _omitFieldNames ? '' : 'uid')
    ..aOM<$22.Timestamp>(6, _omitFieldNames ? '' : 'updateTime', subBuilder: $22.Timestamp.create)
    ..aOM<$22.Timestamp>(7, _omitFieldNames ? '' : 'deleteTime', subBuilder: $22.Timestamp.create)
  ...
  /// created.
  @$pb.TagNumber(4)
  $22.Timestamp get createTime => $_getN(3);
  @$pb.TagNumber(4)
  set createTime($22.Timestamp value) => $_setField(4, value);
  @$pb.TagNumber(4)
  $core.bool hasCreateTime() => $_has(3);
  @$pb.TagNumber(4)
  void clearCreateTime() => $_clearField(4);
  @$pb.TagNumber(4)
  $22.Timestamp ensureCreateTime() => $_ensure(3);
  ...
  @$pb.TagNumber(7)
  $22.Timestamp get deleteTime => $_getN(6);
  @$pb.TagNumber(7)
  set deleteTime($22.Timestamp value) => $_setField(7, value);
  @$pb.TagNumber(7)
  $core.bool hasDeleteTime() => $_has(6);
  @$pb.TagNumber(7)
  void clearDeleteTime() => $_clearField(7);
  @$pb.TagNumber(7)
  $22.Timestamp ensureDeleteTime() => $_ensure(6);
...
class Restrictions extends $pb.GeneratedMessage {
  factory Restrictions({
    ...
    final result = create();
    if (browserKeyRestrictions != null) result.browserKeyRestrictions = browserKeyRestrictions;
    if (serverKeyRestrictions != null) result.serverKeyRestrictions = serverKeyRestrictions;
    if (androidKeyRestrictions != null) result.androidKeyRestrictions = androidKeyRestrictions;
    if (iosKeyRestrictions != null) result.iosKeyRestrictions = iosKeyRestrictions;
  ...
  factory Restrictions.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Restrictions.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  @$pb.TagNumber(1)
  set browserKeyRestrictions(BrowserKeyRestrictions value) => $_setField(1, value);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set serverKeyRestrictions(ServerKeyRestrictions value) => $_setField(2, value);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set androidKeyRestrictions(AndroidKeyRestrictions value) => $_setField(3, value);
  @$pb.TagNumber(3)
...
class BrowserKeyRestrictions extends $pb.GeneratedMessage {
  factory BrowserKeyRestrictions({
    ...
    final result = create();
    if (allowedReferrers != null) result.allowedReferrers.addAll(allowedReferrers);
    return result;
  }

  BrowserKeyRestrictions._();

  factory BrowserKeyRestrictions.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory BrowserKeyRestrictions.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class ServerKeyRestrictions extends $pb.GeneratedMessage {
  ...
  factory ServerKeyRestrictions.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory ServerKeyRestrictions.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class AndroidKeyRestrictions extends $pb.GeneratedMessage {
  factory AndroidKeyRestrictions({
    ...
    final result = create();
    if (allowedApplications != null) result.allowedApplications.addAll(allowedApplications);
    return result;
  }

  AndroidKeyRestrictions._();

  factory AndroidKeyRestrictions.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory AndroidKeyRestrictions.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class AndroidApplication extends $pb.GeneratedMessage {
  ...
  factory AndroidApplication.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory AndroidApplication.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class IosKeyRestrictions extends $pb.GeneratedMessage {
  factory IosKeyRestrictions({
    ...
    final result = create();
    if (allowedBundleIds != null) result.allowedBundleIds.addAll(allowedBundleIds);
    return result;
  }

  IosKeyRestrictions._();

  factory IosKeyRestrictions.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory IosKeyRestrictions.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class ApiTarget extends $pb.GeneratedMessage {
  ...
  factory ApiTarget.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory ApiTarget.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
