...
class ClientLibrarySettings extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClientLibrarySettings', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api'), createEmptyInstance: create)
    ...
    ..e<$24.LaunchStage>(2, _omitFieldNames ? '' : 'launchStage', $pb.PbFieldType.OE, defaultOrMaker: $24.LaunchStage.LAUNCH_STAGE_UNSPECIFIED, valueOf: $24.LaunchStage.valueOf, enumValues: $24.LaunchStage.values)
  ...
  @$pb.TagNumber(2)
  $24.LaunchStage get launchStage => $_getN(1);
  @$pb.TagNumber(2)
  set launchStage($24.LaunchStage value) => $_setField(2, value);
  @$pb.TagNumber(2)
...
class DotnetSettings extends $pb.GeneratedMessage {
  factory DotnetSettings({
    ...
    $core.Iterable<$core.MapEntry<$core.String, $core.String>>? renamedResources,
...
class MethodSettings_LongRunning extends $pb.GeneratedMessage {
  factory MethodSettings_LongRunning({
    $23.Duration? initialPollDelay,
    $core.double? pollDelayMultiplier,
    $23.Duration? maxPollDelay,
    $23.Duration? totalPollTimeout,
  }) {
    final result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MethodSettings.LongRunning', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api'), createEmptyInstance: create)
    ..aOM<$23.Duration>(1, _omitFieldNames ? '' : 'initialPollDelay', subBuilder: $23.Duration.create)
    ..a<$core.double>(2, _omitFieldNames ? '' : 'pollDelayMultiplier', $pb.PbFieldType.OF)
    ..aOM<$23.Duration>(3, _omitFieldNames ? '' : 'maxPollDelay', subBuilder: $23.Duration.create)
    ..aOM<$23.Duration>(4, _omitFieldNames ? '' : 'totalPollTimeout', subBuilder: $23.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $23.Duration get initialPollDelay => $_getN(0);
  @$pb.TagNumber(1)
  set initialPollDelay($23.Duration value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasInitialPollDelay() => $_has(0);
  @$pb.TagNumber(1)
  void clearInitialPollDelay() => $_clearField(1);
  @$pb.TagNumber(1)
  $23.Duration ensureInitialPollDelay() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  $23.Duration get maxPollDelay => $_getN(2);
  @$pb.TagNumber(3)
  set maxPollDelay($23.Duration value) => $_setField(3, value);
  @$pb.TagNumber(3)
  $core.bool hasMaxPollDelay() => $_has(2);
  @$pb.TagNumber(3)
  void clearMaxPollDelay() => $_clearField(3);
  @$pb.TagNumber(3)
  $23.Duration ensureMaxPollDelay() => $_ensure(2);

  /// Total polling timeout.
  /// Default value: 5 minutes.
  @$pb.TagNumber(4)
  $23.Duration get totalPollTimeout => $_getN(3);
  @$pb.TagNumber(4)
  set totalPollTimeout($23.Duration value) => $_setField(4, value);
  @$pb.TagNumber(4)
  $core.bool hasTotalPollTimeout() => $_has(3);
  @$pb.TagNumber(4)
  void clearTotalPollTimeout() => $_clearField(4);
  @$pb.TagNumber(4)
  $23.Duration ensureTotalPollTimeout() => $_ensure(3);
}
