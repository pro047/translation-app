...
class AuditContext extends $pb.GeneratedMessage {
  factory AuditContext({
    ...
    $1.Struct? scrubbedRequest,
    $1.Struct? scrubbedResponse,
    ...
    if (scrubbedResponseItemCount != null) result.scrubbedResponseItemCount = scrubbedResponseItemCount;
  ...
  factory AuditContext.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory AuditContext.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AuditContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.rpc.context'), createEmptyInstance: create)
    ...
    ..aOM<$1.Struct>(2, _omitFieldNames ? '' : 'scrubbedRequest', subBuilder: $1.Struct.create)
    ..aOM<$1.Struct>(3, _omitFieldNames ? '' : 'scrubbedResponse', subBuilder: $1.Struct.create)
  ...
  @$pb.TagNumber(2)
  $1.Struct get scrubbedRequest => $_getN(1);
  @$pb.TagNumber(2)
  set scrubbedRequest($1.Struct value) => $_setField(2, value);
  @$pb.TagNumber(2)
  $core.bool hasScrubbedRequest() => $_has(1);
  @$pb.TagNumber(2)
  void clearScrubbedRequest() => $_clearField(2);
  @$pb.TagNumber(2)
  $1.Struct ensureScrubbedRequest() => $_ensure(1);
  ...
  /// Logs and Google internal audit logs.
  @$pb.TagNumber(3)
  $1.Struct get scrubbedResponse => $_getN(2);
  @$pb.TagNumber(3)
  set scrubbedResponse($1.Struct value) => $_setField(3, value);
  @$pb.TagNumber(3)
  $core.bool hasScrubbedResponse() => $_has(2);
  @$pb.TagNumber(3)
  void clearScrubbedResponse() => $_clearField(3);
  @$pb.TagNumber(3)
  $1.Struct ensureScrubbedResponse() => $_ensure(2);
