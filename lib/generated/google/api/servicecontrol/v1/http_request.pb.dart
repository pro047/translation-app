...
class HttpRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.servicecontrol.v1'), createEmptyInstance: create)
    ...
    ..aOM<$23.Duration>(14, _omitFieldNames ? '' : 'latency', subBuilder: $23.Duration.create)
  ...
  @$pb.TagNumber(14)
  $23.Duration get latency => $_getN(13);
  @$pb.TagNumber(14)
  set latency($23.Duration value) => $_setField(14, value);
  @$pb.TagNumber(14)
  $core.bool hasLatency() => $_has(13);
  @$pb.TagNumber(14)
  void clearLatency() => $_clearField(14);
  @$pb.TagNumber(14)
  $23.Duration ensureLatency() => $_ensure(13);
