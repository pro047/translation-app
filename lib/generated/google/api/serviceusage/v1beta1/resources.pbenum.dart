...
class State extends $pb.ProtobufEnum {
  ...
  static final $core.List<State?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 2);
...
class QuotaView extends $pb.ProtobufEnum {
  ...
  static final $core.List<QuotaView?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 2);
  static QuotaView? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
