...
class ContextRule extends $pb.GeneratedMessage {
  factory ContextRule({
    ...
    if (allowedRequestExtensions != null) result.allowedRequestExtensions.addAll(allowedRequestExtensions);
    if (allowedResponseExtensions != null) result.allowedResponseExtensions.addAll(allowedResponseExtensions);
    return result;
  }

  ContextRule._();

  factory ContextRule.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory ContextRule.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
