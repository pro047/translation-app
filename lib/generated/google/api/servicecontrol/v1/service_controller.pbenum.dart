...
class CheckResponse_ConsumerInfo_ConsumerType extends $pb.ProtobufEnum {
  ...
  static final $core.List<CheckResponse_ConsumerInfo_ConsumerType?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 4);
  static CheckResponse_ConsumerInfo_ConsumerType? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
