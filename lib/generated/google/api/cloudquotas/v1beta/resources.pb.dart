...
class QuotaInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'QuotaInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.cloudquotas.v1beta'), createEmptyInstance: create)
...
class QuotaIncreaseEligibility extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'QuotaIncreaseEligibility', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.cloudquotas.v1beta'), createEmptyInstance: create)
...
class QuotaPreference extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'QuotaPreference', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.cloudquotas.v1beta'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..m<$core.String, $core.String>(2, _omitFieldNames ? '' : 'dimensions', entryClassName: 'QuotaPreference.DimensionsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.api.cloudquotas.v1beta'))
...
class QuotaConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'QuotaConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.cloudquotas.v1beta'), createEmptyInstance: create)
    ...
    ..m<$core.String, $core.String>(5, _omitFieldNames ? '' : 'annotations', entryClassName: 'QuotaConfig.AnnotationsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.api.cloudquotas.v1beta'))
...
class DimensionsInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DimensionsInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.cloudquotas.v1beta'), createEmptyInstance: create)
    ..m<$core.String, $core.String>(1, _omitFieldNames ? '' : 'dimensions', entryClassName: 'DimensionsInfo.DimensionsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.api.cloudquotas.v1beta'))
...
class QuotaDetails extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'QuotaDetails', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.cloudquotas.v1beta'), createEmptyInstance: create)
...
class RolloutInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RolloutInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.cloudquotas.v1beta'), createEmptyInstance: create)
