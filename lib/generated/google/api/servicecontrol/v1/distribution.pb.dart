...
class Distribution_LinearBuckets extends $pb.GeneratedMessage {
  ...
  factory Distribution_LinearBuckets.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Distribution_LinearBuckets.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class Distribution_ExponentialBuckets extends $pb.GeneratedMessage {
  ...
  factory Distribution_ExponentialBuckets.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Distribution_ExponentialBuckets.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class Distribution_ExplicitBuckets extends $pb.GeneratedMessage {
  ...
  factory Distribution_ExplicitBuckets.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Distribution_ExplicitBuckets.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class Distribution extends $pb.GeneratedMessage {
  factory Distribution({
    ...
    $core.Iterable<$57.Distribution_Exemplar>? exemplars,
  }) {
    final result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Distribution', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.servicecontrol.v1'), createEmptyInstance: create)
    ...
    ..pc<$57.Distribution_Exemplar>(10, _omitFieldNames ? '' : 'exemplars', $pb.PbFieldType.PM, subBuilder: $57.Distribution_Exemplar.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(8)
  set exponentialBuckets(Distribution_ExponentialBuckets value) => $_setField(8, value);
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set explicitBuckets(Distribution_ExplicitBuckets value) => $_setField(9, value);
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  $pb.PbList<$57.Distribution_Exemplar> get exemplars => $_getList(9);
}
