...
class SourceInfo_Extension_Component extends $pb.ProtobufEnum {
  ...
  static final $core.List<SourceInfo_Extension_Component?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 3);
  static SourceInfo_Extension_Component? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
