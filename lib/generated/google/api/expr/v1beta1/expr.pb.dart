...
class ParsedExpr extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ParsedExpr', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$36.SourceInfo>(3, _omitFieldNames ? '' : 'sourceInfo', subBuilder: $36.SourceInfo.create)
  ...
  @$pb.TagNumber(3)
  $36.SourceInfo get sourceInfo => $_getN(1);
  @$pb.TagNumber(3)
  set sourceInfo($36.SourceInfo value) => $_setField(3, value);
  @$pb.TagNumber(3)
  $core.bool hasSourceInfo() => $_has(1);
  @$pb.TagNumber(3)
  void clearSourceInfo() => $_clearField(3);
  @$pb.TagNumber(3)
  $36.SourceInfo ensureSourceInfo() => $_ensure(1);
...
class Literal extends $pb.GeneratedMessage {
  ...
  factory Literal.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Literal.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
