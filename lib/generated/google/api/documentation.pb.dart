...
class Documentation extends $pb.GeneratedMessage {
  factory Documentation({
    ...
    if (documentationRootUrl != null) result.documentationRootUrl = documentationRootUrl;
  ...
  factory Documentation.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Documentation.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class DocumentationRule extends $pb.GeneratedMessage {
  factory DocumentationRule({
    ...
    if (deprecationDescription != null) result.deprecationDescription = deprecationDescription;
    return result;
  }

  DocumentationRule._();

  factory DocumentationRule.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory DocumentationRule.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
