...
class DeclType extends $pb.GeneratedMessage {
  ...
  factory DeclType.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory DeclType.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class IdentDecl extends $pb.GeneratedMessage {
  ...
  factory IdentDecl.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory IdentDecl.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'IdentDecl', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$34.Expr>(4, _omitFieldNames ? '' : 'value', subBuilder: $34.Expr.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $34.Expr get value => $_getN(1);
  @$pb.TagNumber(4)
  set value($34.Expr value) => $_setField(4, value);
  @$pb.TagNumber(4)
  $core.bool hasValue() => $_has(1);
  @$pb.TagNumber(4)
  void clearValue() => $_clearField(4);
  @$pb.TagNumber(4)
  $34.Expr ensureValue() => $_ensure(1);
}
...
class FunctionDecl extends $pb.GeneratedMessage {
  ...
  factory FunctionDecl.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory FunctionDecl.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
