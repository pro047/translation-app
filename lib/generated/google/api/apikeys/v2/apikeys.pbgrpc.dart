...
class ApiKeysClient extends $grpc.Client {
  ...
  static final _$createKey = $grpc.ClientMethod<$0.CreateKeyRequest, $1.Operation>(
  ...
  static final _$getKeyString = $grpc.ClientMethod<$0.GetKeyStringRequest, $0.GetKeyStringResponse>(
      '/google.api.apikeys.v2.ApiKeys/GetKeyString',
      ($0.GetKeyStringRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.GetKeyStringResponse.fromBuffer(value));
  static final _$updateKey = $grpc.ClientMethod<$0.UpdateKeyRequest, $1.Operation>(
      '/google.api.apikeys.v2.ApiKeys/UpdateKey',
      ($0.UpdateKeyRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.Operation.fromBuffer(value));
  static final _$deleteKey = $grpc.ClientMethod<$0.DeleteKeyRequest, $1.Operation>(
      '/google.api.apikeys.v2.ApiKeys/DeleteKey',
      ($0.DeleteKeyRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.Operation.fromBuffer(value));
  static final _$undeleteKey = $grpc.ClientMethod<$0.UndeleteKeyRequest, $1.Operation>(
      '/google.api.apikeys.v2.ApiKeys/UndeleteKey',
      ($0.UndeleteKeyRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.Operation.fromBuffer(value));
  static final _$lookupKey = $grpc.ClientMethod<$0.LookupKeyRequest, $0.LookupKeyResponse>(
      '/google.api.apikeys.v2.ApiKeys/LookupKey',
      ($0.LookupKeyRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.LookupKeyResponse.fromBuffer(value));
  ...
  /// location is `global`.
  $grpc.ResponseFuture<$1.Operation> createKey($0.CreateKeyRequest request, {$grpc.CallOptions? options}) {
  ...
  /// NOTE: Key is a global resource; hence the only supported value for
  /// location is `global`.
  $grpc.ResponseFuture<$2.Key> getKey($0.GetKeyRequest request, {$grpc.CallOptions? options}) {
  ...
  /// NOTE: Key is a global resource; hence the only supported value for
  /// location is `global`.
  $grpc.ResponseFuture<$0.GetKeyStringResponse> getKeyString($0.GetKeyStringRequest request, {$grpc.CallOptions? options}) {
  ...
  /// NOTE: Key is a global resource; hence the only supported value for
  /// location is `global`.
  $grpc.ResponseFuture<$1.Operation> updateKey($0.UpdateKeyRequest request, {$grpc.CallOptions? options}) {
  ...
  /// NOTE: Key is a global resource; hence the only supported value for
  /// location is `global`.
  $grpc.ResponseFuture<$1.Operation> deleteKey($0.DeleteKeyRequest request, {$grpc.CallOptions? options}) {
  ...
  /// NOTE: Key is a global resource; hence the only supported value for
  /// location is `global`.
  $grpc.ResponseFuture<$1.Operation> undeleteKey($0.UndeleteKeyRequest request, {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.LookupKeyResponse> lookupKey($0.LookupKeyRequest request, {$grpc.CallOptions? options}) {
...
abstract class ApiKeysServiceBase extends $grpc.Service {
  ...
  ApiKeysServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.GetKeyStringRequest, $0.GetKeyStringResponse>(
        'GetKeyString',
        getKeyString_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetKeyStringRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.UndeleteKeyRequest, $1.Operation>(
        ...
        false,
        false,
        ($core.List<$core.int> value) => $0.UndeleteKeyRequest.fromBuffer(value),
        ($1.Operation value) => value.writeToBuffer()));
  ...
  $async.Future<$1.Operation> createKey_Pre($grpc.ServiceCall $call, $async.Future<$0.CreateKeyRequest> $request) async {
  ...
  $async.Future<$2.Key> getKey_Pre($grpc.ServiceCall $call, $async.Future<$0.GetKeyRequest> $request) async {
    return getKey($call, await $request);
  }

  $async.Future<$0.GetKeyStringResponse> getKeyString_Pre($grpc.ServiceCall $call, $async.Future<$0.GetKeyStringRequest> $request) async {
    return getKeyString($call, await $request);
  }

  $async.Future<$1.Operation> updateKey_Pre($grpc.ServiceCall $call, $async.Future<$0.UpdateKeyRequest> $request) async {
    return updateKey($call, await $request);
  }

  $async.Future<$1.Operation> deleteKey_Pre($grpc.ServiceCall $call, $async.Future<$0.DeleteKeyRequest> $request) async {
    return deleteKey($call, await $request);
  }

  $async.Future<$1.Operation> undeleteKey_Pre($grpc.ServiceCall $call, $async.Future<$0.UndeleteKeyRequest> $request) async {
    return undeleteKey($call, await $request);
  }

  $async.Future<$0.LookupKeyResponse> lookupKey_Pre($grpc.ServiceCall $call, $async.Future<$0.LookupKeyRequest> $request) async {
    return lookupKey($call, await $request);
  }

  $async.Future<$1.Operation> createKey($grpc.ServiceCall call, $0.CreateKeyRequest request);
  $async.Future<$0.ListKeysResponse> listKeys($grpc.ServiceCall call, $0.ListKeysRequest request);
  $async.Future<$2.Key> getKey($grpc.ServiceCall call, $0.GetKeyRequest request);
  $async.Future<$0.GetKeyStringResponse> getKeyString($grpc.ServiceCall call, $0.GetKeyStringRequest request);
  $async.Future<$1.Operation> updateKey($grpc.ServiceCall call, $0.UpdateKeyRequest request);
  $async.Future<$1.Operation> deleteKey($grpc.ServiceCall call, $0.DeleteKeyRequest request);
  $async.Future<$1.Operation> undeleteKey($grpc.ServiceCall call, $0.UndeleteKeyRequest request);
  $async.Future<$0.LookupKeyResponse> lookupKey($grpc.ServiceCall call, $0.LookupKeyRequest request);
}
