...
class Monitoring_MonitoringDestination extends $pb.GeneratedMessage {
  ...
  factory Monitoring_MonitoringDestination.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Monitoring_MonitoringDestination.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class Monitoring extends $pb.GeneratedMessage {
  factory Monitoring({
    ...
    final result = create();
    if (producerDestinations != null) result.producerDestinations.addAll(producerDestinations);
    if (consumerDestinations != null) result.consumerDestinations.addAll(consumerDestinations);
    return result;
  }

  Monitoring._();

  factory Monitoring.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Monitoring.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  @$pb.TagNumber(1)
  $pb.PbList<Monitoring_MonitoringDestination> get producerDestinations => $_getList(0);
  ...
  /// in the Monitoring configuration.
  @$pb.TagNumber(2)
  $pb.PbList<Monitoring_MonitoringDestination> get consumerDestinations => $_getList(1);
}
