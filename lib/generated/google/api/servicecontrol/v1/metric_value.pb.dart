...
import 'distribution.pb.dart' as $60;
...
class MetricValue extends $pb.GeneratedMessage {
  factory MetricValue({
    ...
    $60.Distribution? distributionValue,
  }) {
    final result = create();
  ...
  factory MetricValue.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory MetricValue.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MetricValue', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.servicecontrol.v1'), createEmptyInstance: create)
    ...
    ..aOM<$22.Timestamp>(2, _omitFieldNames ? '' : 'startTime', subBuilder: $22.Timestamp.create)
    ..aOM<$22.Timestamp>(3, _omitFieldNames ? '' : 'endTime', subBuilder: $22.Timestamp.create)
    ...
    ..aOM<$60.Distribution>(8, _omitFieldNames ? '' : 'distributionValue', subBuilder: $60.Distribution.create)
  ...
  @$pb.TagNumber(2)
  $22.Timestamp get startTime => $_getN(1);
  @$pb.TagNumber(2)
  set startTime($22.Timestamp value) => $_setField(2, value);
  @$pb.TagNumber(2)
  $core.bool hasStartTime() => $_has(1);
  @$pb.TagNumber(2)
  void clearStartTime() => $_clearField(2);
  @$pb.TagNumber(2)
  $22.Timestamp ensureStartTime() => $_ensure(1);

  /// The end of the time period over which this metric value's measurement
  /// applies.  If not specified,
  /// [google.api.servicecontrol.v1.Operation.end_time][google.api.servicecontrol.v1.Operation.end_time] will be used.
  @$pb.TagNumber(3)
  $22.Timestamp get endTime => $_getN(2);
  @$pb.TagNumber(3)
  set endTime($22.Timestamp value) => $_setField(3, value);
  @$pb.TagNumber(3)
  $core.bool hasEndTime() => $_has(2);
  @$pb.TagNumber(3)
  void clearEndTime() => $_clearField(3);
  @$pb.TagNumber(3)
  $22.Timestamp ensureEndTime() => $_ensure(2);
  ...
  @$pb.TagNumber(8)
  $60.Distribution get distributionValue => $_getN(7);
  @$pb.TagNumber(8)
  set distributionValue($60.Distribution value) => $_setField(8, value);
  @$pb.TagNumber(8)
  $core.bool hasDistributionValue() => $_has(7);
  @$pb.TagNumber(8)
  void clearDistributionValue() => $_clearField(8);
  @$pb.TagNumber(8)
  $60.Distribution ensureDistributionValue() => $_ensure(7);
}
...
class MetricValueSet extends $pb.GeneratedMessage {
  ...
  factory MetricValueSet.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory MetricValueSet.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
