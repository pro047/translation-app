...
class Billing_BillingDestination extends $pb.GeneratedMessage {
  ...
  factory Billing_BillingDestination.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Billing_BillingDestination.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class Billing extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(8)
  $pb.PbList<Billing_BillingDestination> get consumerDestinations => $_getList(0);
}
