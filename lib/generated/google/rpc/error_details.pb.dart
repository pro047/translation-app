...
class RetryInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RetryInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.rpc'), createEmptyInstance: create)
    ..aOM<$3.Duration>(1, _omitFieldNames ? '' : 'retryDelay', subBuilder: $3.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $3.Duration get retryDelay => $_getN(0);
  @$pb.TagNumber(1)
  set retryDelay($3.Duration value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasRetryDelay() => $_has(0);
  @$pb.TagNumber(1)
  void clearRetryDelay() => $_clearField(1);
  @$pb.TagNumber(1)
  $3.Duration ensureRetryDelay() => $_ensure(0);
}
...
class QuotaFailure_Violation extends $pb.GeneratedMessage {
  factory QuotaFailure_Violation({
    ...
    if (quotaDimensions != null) result.quotaDimensions.addEntries(quotaDimensions);
