...
class Usage extends $pb.GeneratedMessage {
  factory Usage({
    ...
    if (producerNotificationChannel != null) result.producerNotificationChannel = producerNotificationChannel;
    return result;
  }

  Usage._();

  factory Usage.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Usage.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class UsageRule extends $pb.GeneratedMessage {
  factory UsageRule({
    ...
    if (allowUnregisteredCalls != null) result.allowUnregisteredCalls = allowUnregisteredCalls;
    if (skipServiceControl != null) result.skipServiceControl = skipServiceControl;
    return result;
  }

  UsageRule._();

  factory UsageRule.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory UsageRule.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
