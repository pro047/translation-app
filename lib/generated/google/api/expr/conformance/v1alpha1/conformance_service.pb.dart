...
import '../../v1alpha1/checked.pb.dart' as $30;
import '../../v1alpha1/eval.pb.dart' as $31;
import '../../v1alpha1/syntax.pb.dart' as $28;
...
class ParseRequest extends $pb.GeneratedMessage {
  ...
  factory ParseRequest.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory ParseRequest.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class ParseResponse extends $pb.GeneratedMessage {
  factory ParseResponse({
    $28.ParsedExpr? parsedExpr,
    $core.Iterable<$29.Status>? issues,
  }) {
    final result = create();
  ...
  factory ParseResponse.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory ParseResponse.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ParseResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.conformance.v1alpha1'), createEmptyInstance: create)
    ..aOM<$28.ParsedExpr>(1, _omitFieldNames ? '' : 'parsedExpr', subBuilder: $28.ParsedExpr.create)
    ..pc<$29.Status>(2, _omitFieldNames ? '' : 'issues', $pb.PbFieldType.PM, subBuilder: $29.Status.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $28.ParsedExpr get parsedExpr => $_getN(0);
  @$pb.TagNumber(1)
  set parsedExpr($28.ParsedExpr value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasParsedExpr() => $_has(0);
  @$pb.TagNumber(1)
  void clearParsedExpr() => $_clearField(1);
  @$pb.TagNumber(1)
  $28.ParsedExpr ensureParsedExpr() => $_ensure(0);

  /// Any number of issues with [StatusDetails][] as the details.
  @$pb.TagNumber(2)
  $pb.PbList<$29.Status> get issues => $_getList(1);
}
...
class CheckRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CheckRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.conformance.v1alpha1'), createEmptyInstance: create)
    ..aOM<$28.ParsedExpr>(1, _omitFieldNames ? '' : 'parsedExpr', subBuilder: $28.ParsedExpr.create)
    ..pc<$30.Decl>(2, _omitFieldNames ? '' : 'typeEnv', $pb.PbFieldType.PM, subBuilder: $30.Decl.create)
  ...
  @$pb.TagNumber(2)
  $pb.PbList<$30.Decl> get typeEnv => $_getList(1);
...
class CheckResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CheckResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.conformance.v1alpha1'), createEmptyInstance: create)
    ..aOM<$30.CheckedExpr>(1, _omitFieldNames ? '' : 'checkedExpr', subBuilder: $30.CheckedExpr.create)
    ..pc<$29.Status>(2, _omitFieldNames ? '' : 'issues', $pb.PbFieldType.PM, subBuilder: $29.Status.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $30.CheckedExpr get checkedExpr => $_getN(0);
  @$pb.TagNumber(1)
  set checkedExpr($30.CheckedExpr value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasCheckedExpr() => $_has(0);
  @$pb.TagNumber(1)
  void clearCheckedExpr() => $_clearField(1);
  @$pb.TagNumber(1)
  $30.CheckedExpr ensureCheckedExpr() => $_ensure(0);
...
class EvalRequest extends $pb.GeneratedMessage {
  factory EvalRequest({
    $28.ParsedExpr? parsedExpr,
    $30.CheckedExpr? checkedExpr,
    $core.Iterable<$core.MapEntry<$core.String, $31.ExprValue>>? bindings,
    $core.String? container,
  }) {
    final result = create();
    if (parsedExpr != null) result.parsedExpr = parsedExpr;
  ...
  factory EvalRequest.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory EvalRequest.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EvalRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.conformance.v1alpha1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$28.ParsedExpr>(1, _omitFieldNames ? '' : 'parsedExpr', subBuilder: $28.ParsedExpr.create)
    ..aOM<$30.CheckedExpr>(2, _omitFieldNames ? '' : 'checkedExpr', subBuilder: $30.CheckedExpr.create)
    ..m<$core.String, $31.ExprValue>(3, _omitFieldNames ? '' : 'bindings', entryClassName: 'EvalRequest.BindingsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $31.ExprValue.create, valueDefaultOrMaker: $31.ExprValue.getDefault, packageName: const $pb.PackageName('google.api.expr.conformance.v1alpha1'))
  ...
  @$pb.TagNumber(2)
  $30.CheckedExpr get checkedExpr => $_getN(1);
  @$pb.TagNumber(2)
  set checkedExpr($30.CheckedExpr value) => $_setField(2, value);
  @$pb.TagNumber(2)
  $core.bool hasCheckedExpr() => $_has(1);
  @$pb.TagNumber(2)
  void clearCheckedExpr() => $_clearField(2);
  @$pb.TagNumber(2)
  $30.CheckedExpr ensureCheckedExpr() => $_ensure(1);

  /// Bindings for the external variables.  The types SHOULD be compatible
  /// with the type environment in [CheckRequest][google.api.expr.conformance.v1alpha1.CheckRequest], if checked.
  @$pb.TagNumber(3)
  $pb.PbMap<$core.String, $31.ExprValue> get bindings => $_getMap(2);
...
class EvalResponse extends $pb.GeneratedMessage {
  ...
  factory EvalResponse.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory EvalResponse.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EvalResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.conformance.v1alpha1'), createEmptyInstance: create)
    ..aOM<$31.ExprValue>(1, _omitFieldNames ? '' : 'result', subBuilder: $31.ExprValue.create)
    ..pc<$29.Status>(2, _omitFieldNames ? '' : 'issues', $pb.PbFieldType.PM, subBuilder: $29.Status.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $31.ExprValue get result => $_getN(0);
  @$pb.TagNumber(1)
  set result($31.ExprValue value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasResult() => $_has(0);
  @$pb.TagNumber(1)
  void clearResult() => $_clearField(1);
  @$pb.TagNumber(1)
  $31.ExprValue ensureResult() => $_ensure(0);
...
class IssueDetails extends $pb.GeneratedMessage {
  ...
  factory IssueDetails.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory IssueDetails.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
