...
import '../../../rpc/context/attribute_context.pb.dart' as $65;
...
class CheckRequest extends $pb.GeneratedMessage {
  factory CheckRequest({
    ...
    $65.AttributeContext? attributes,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CheckRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.servicecontrol.v2'), createEmptyInstance: create)
    ...
    ..aOM<$65.AttributeContext>(3, _omitFieldNames ? '' : 'attributes', subBuilder: $65.AttributeContext.create)
  ...
  @$pb.TagNumber(3)
  $65.AttributeContext get attributes => $_getN(2);
  @$pb.TagNumber(3)
  set attributes($65.AttributeContext value) => $_setField(3, value);
  @$pb.TagNumber(3)
  $core.bool hasAttributes() => $_has(2);
  @$pb.TagNumber(3)
  void clearAttributes() => $_clearField(3);
  @$pb.TagNumber(3)
  $65.AttributeContext ensureAttributes() => $_ensure(2);
...
class CheckResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CheckResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.servicecontrol.v2'), createEmptyInstance: create)
    ..aOM<$29.Status>(1, _omitFieldNames ? '' : 'status', subBuilder: $29.Status.create)
  ...
  @$pb.TagNumber(1)
  $29.Status get status => $_getN(0);
  @$pb.TagNumber(1)
  set status($29.Status value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasStatus() => $_has(0);
  @$pb.TagNumber(1)
  void clearStatus() => $_clearField(1);
  @$pb.TagNumber(1)
  $29.Status ensureStatus() => $_ensure(0);
...
class ReportRequest extends $pb.GeneratedMessage {
  factory ReportRequest({
    $core.String? serviceName,
    $core.String? serviceConfigId,
    $core.Iterable<$65.AttributeContext>? operations,
  }) {
    final result = create();
    if (serviceName != null) result.serviceName = serviceName;
    if (serviceConfigId != null) result.serviceConfigId = serviceConfigId;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReportRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.servicecontrol.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'serviceName')
    ..aOS(2, _omitFieldNames ? '' : 'serviceConfigId')
    ..pc<$65.AttributeContext>(3, _omitFieldNames ? '' : 'operations', $pb.PbFieldType.PM, subBuilder: $65.AttributeContext.create)
    ..hasRequiredFields = false
  ;
  ...
  /// API access.
  @$pb.TagNumber(3)
  $pb.PbList<$65.AttributeContext> get operations => $_getList(2);
}
...
class ResourceInfoList extends $pb.GeneratedMessage {
  ...
  factory ResourceInfoList.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory ResourceInfoList.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
