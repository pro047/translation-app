...
class Property_PropertyType extends $pb.ProtobufEnum {
  ...
  static final $core.List<Property_PropertyType?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 4);
  static Property_PropertyType? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
