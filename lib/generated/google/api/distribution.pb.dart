...
class Distribution_Range extends $pb.GeneratedMessage {
  ...
  factory Distribution_Range.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Distribution_Range.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class Distribution_BucketOptions_Linear extends $pb.GeneratedMessage {
  ...
  factory Distribution_BucketOptions_Linear.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Distribution_BucketOptions_Linear.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class Distribution_BucketOptions_Exponential extends $pb.GeneratedMessage {
  ...
  factory Distribution_BucketOptions_Exponential.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Distribution_BucketOptions_Exponential.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class Distribution_BucketOptions_Explicit extends $pb.GeneratedMessage {
  ...
  factory Distribution_BucketOptions_Explicit.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Distribution_BucketOptions_Explicit.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class Distribution_BucketOptions extends $pb.GeneratedMessage {
  factory Distribution_BucketOptions({
    ...
    if (exponentialBuckets != null) result.exponentialBuckets = exponentialBuckets;
  ...
  factory Distribution_BucketOptions.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Distribution_BucketOptions.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  @$pb.TagNumber(1)
  set linearBuckets(Distribution_BucketOptions_Linear value) => $_setField(1, value);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set exponentialBuckets(Distribution_BucketOptions_Exponential value) => $_setField(2, value);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set explicitBuckets(Distribution_BucketOptions_Explicit value) => $_setField(3, value);
  @$pb.TagNumber(3)
...
class Distribution_Exemplar extends $pb.GeneratedMessage {
  factory Distribution_Exemplar({
    ...
    $core.Iterable<$27.Any>? attachments,
  }) {
    final result = create();
  ...
  factory Distribution_Exemplar.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Distribution_Exemplar.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Distribution.Exemplar', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api'), createEmptyInstance: create)
    ...
    ..aOM<$22.Timestamp>(2, _omitFieldNames ? '' : 'timestamp', subBuilder: $22.Timestamp.create)
    ..pc<$27.Any>(3, _omitFieldNames ? '' : 'attachments', $pb.PbFieldType.PM, subBuilder: $27.Any.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $22.Timestamp get timestamp => $_getN(1);
  @$pb.TagNumber(2)
  set timestamp($22.Timestamp value) => $_setField(2, value);
  @$pb.TagNumber(2)
  $core.bool hasTimestamp() => $_has(1);
  @$pb.TagNumber(2)
  void clearTimestamp() => $_clearField(2);
  @$pb.TagNumber(2)
  $22.Timestamp ensureTimestamp() => $_ensure(1);
  ...
  @$pb.TagNumber(3)
  $pb.PbList<$27.Any> get attachments => $_getList(2);
}
...
class Distribution extends $pb.GeneratedMessage {
  factory Distribution({
    ...
    if (sumOfSquaredDeviation != null) result.sumOfSquaredDeviation = sumOfSquaredDeviation;
  ...
  factory Distribution.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Distribution.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
