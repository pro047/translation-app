...
class ChangeType extends $pb.ProtobufEnum {
  ...
  static final $core.List<ChangeType?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 3);
  static ChangeType? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
