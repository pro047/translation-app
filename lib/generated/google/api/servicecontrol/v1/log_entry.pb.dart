...
import '../../../logging/type/log_severity.pbenum.dart' as $59;
import '../../../protobuf/any.pb.dart' as $27;
import '../../../protobuf/struct.pb.dart' as $32;
import '../../../protobuf/timestamp.pb.dart' as $22;
import 'http_request.pb.dart' as $58;
...
class LogEntry extends $pb.GeneratedMessage {
  factory LogEntry({
    ...
    $32.Struct? structPayload,
    $core.String? name,
    $22.Timestamp? timestamp,
    $59.LogSeverity? severity,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LogEntry', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.servicecontrol.v1'), createEmptyInstance: create)
    ..oo(0, [2, 3, 6])
    ..aOM<$27.Any>(2, _omitFieldNames ? '' : 'protoPayload', subBuilder: $27.Any.create)
    ..aOS(3, _omitFieldNames ? '' : 'textPayload')
    ..aOS(4, _omitFieldNames ? '' : 'insertId')
    ..aOM<$32.Struct>(6, _omitFieldNames ? '' : 'structPayload', subBuilder: $32.Struct.create)
    ..aOS(10, _omitFieldNames ? '' : 'name')
    ..aOM<$22.Timestamp>(11, _omitFieldNames ? '' : 'timestamp', subBuilder: $22.Timestamp.create)
    ..e<$59.LogSeverity>(12, _omitFieldNames ? '' : 'severity', $pb.PbFieldType.OE, defaultOrMaker: $59.LogSeverity.DEFAULT, valueOf: $59.LogSeverity.valueOf, enumValues: $59.LogSeverity.values)
    ...
    ..aOM<$58.HttpRequest>(14, _omitFieldNames ? '' : 'httpRequest', subBuilder: $58.HttpRequest.create)
  ...
  @$pb.TagNumber(2)
  $27.Any get protoPayload => $_getN(0);
  @$pb.TagNumber(2)
  set protoPayload($27.Any value) => $_setField(2, value);
  @$pb.TagNumber(2)
  $core.bool hasProtoPayload() => $_has(0);
  @$pb.TagNumber(2)
  void clearProtoPayload() => $_clearField(2);
  @$pb.TagNumber(2)
  $27.Any ensureProtoPayload() => $_ensure(0);
  ...
  @$pb.TagNumber(6)
  $32.Struct get structPayload => $_getN(3);
  @$pb.TagNumber(6)
  set structPayload($32.Struct value) => $_setField(6, value);
  @$pb.TagNumber(6)
  $core.bool hasStructPayload() => $_has(3);
  @$pb.TagNumber(6)
  void clearStructPayload() => $_clearField(6);
  @$pb.TagNumber(6)
  $32.Struct ensureStructPayload() => $_ensure(3);
  ...
  @$pb.TagNumber(11)
  $22.Timestamp get timestamp => $_getN(5);
  @$pb.TagNumber(11)
  set timestamp($22.Timestamp value) => $_setField(11, value);
  @$pb.TagNumber(11)
  $core.bool hasTimestamp() => $_has(5);
  @$pb.TagNumber(11)
  void clearTimestamp() => $_clearField(11);
  @$pb.TagNumber(11)
  $22.Timestamp ensureTimestamp() => $_ensure(5);

  /// The severity of the log entry. The default value is
  /// `LogSeverity.DEFAULT`.
  @$pb.TagNumber(12)
  $59.LogSeverity get severity => $_getN(6);
  @$pb.TagNumber(12)
  set severity($59.LogSeverity value) => $_setField(12, value);
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(14)
  $58.HttpRequest get httpRequest => $_getN(8);
  @$pb.TagNumber(14)
  set httpRequest($58.HttpRequest value) => $_setField(14, value);
  @$pb.TagNumber(14)
  $core.bool hasHttpRequest() => $_has(8);
  @$pb.TagNumber(14)
  void clearHttpRequest() => $_clearField(14);
  @$pb.TagNumber(14)
  $58.HttpRequest ensureHttpRequest() => $_ensure(8);
...
class LogEntryOperation extends $pb.GeneratedMessage {
  ...
  factory LogEntryOperation.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory LogEntryOperation.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class LogEntrySourceLocation extends $pb.GeneratedMessage {
  ...
  factory LogEntrySourceLocation.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory LogEntrySourceLocation.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
