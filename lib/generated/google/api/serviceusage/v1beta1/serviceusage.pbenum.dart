...
class GetServiceIdentityResponse_IdentityState extends $pb.ProtobufEnum {
  ...
  static final $core.List<GetServiceIdentityResponse_IdentityState?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 1);
  static GetServiceIdentityResponse_IdentityState? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
