...
class GetServiceConfigRequest_ConfigView extends $pb.ProtobufEnum {
  ...
  static final $core.List<GetServiceConfigRequest_ConfigView?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 1);
  static GetServiceConfigRequest_ConfigView? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
