...
class MonitoredResourceDescriptor extends $pb.GeneratedMessage {
  ...
  factory MonitoredResourceDescriptor.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory MonitoredResourceDescriptor.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MonitoredResourceDescriptor', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api'), createEmptyInstance: create)
    ...
    ..pc<$37.LabelDescriptor>(4, _omitFieldNames ? '' : 'labels', $pb.PbFieldType.PM, subBuilder: $37.LabelDescriptor.create)
    ..aOS(5, _omitFieldNames ? '' : 'name')
    ..e<$24.LaunchStage>(7, _omitFieldNames ? '' : 'launchStage', $pb.PbFieldType.OE, defaultOrMaker: $24.LaunchStage.LAUNCH_STAGE_UNSPECIFIED, valueOf: $24.LaunchStage.valueOf, enumValues: $24.LaunchStage.values)
  ...
  @$pb.TagNumber(4)
  $pb.PbList<$37.LabelDescriptor> get labels => $_getList(3);
  ...
  @$pb.TagNumber(7)
  $24.LaunchStage get launchStage => $_getN(5);
  @$pb.TagNumber(7)
  set launchStage($24.LaunchStage value) => $_setField(7, value);
  @$pb.TagNumber(7)
...
class MonitoredResource extends $pb.GeneratedMessage {
  ...
  factory MonitoredResource.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory MonitoredResource.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class MonitoredResourceMetadata extends $pb.GeneratedMessage {
  ...
  factory MonitoredResourceMetadata.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory MonitoredResourceMetadata.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MonitoredResourceMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api'), createEmptyInstance: create)
    ..aOM<$32.Struct>(1, _omitFieldNames ? '' : 'systemLabels', subBuilder: $32.Struct.create)
  ...
  ///       "spot_instance": false }
  @$pb.TagNumber(1)
  $32.Struct get systemLabels => $_getN(0);
  @$pb.TagNumber(1)
  set systemLabels($32.Struct value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasSystemLabels() => $_has(0);
  @$pb.TagNumber(1)
  void clearSystemLabels() => $_clearField(1);
  @$pb.TagNumber(1)
  $32.Struct ensureSystemLabels() => $_ensure(0);
