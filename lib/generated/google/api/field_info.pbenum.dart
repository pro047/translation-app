...
class FieldInfo_Format extends $pb.ProtobufEnum {
  ...
  static final $core.List<FieldInfo_Format?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 4);
  static FieldInfo_Format? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
