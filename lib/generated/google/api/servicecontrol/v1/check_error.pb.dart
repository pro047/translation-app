...
class CheckError extends $pb.GeneratedMessage {
  ...
  factory CheckError.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory CheckError.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CheckError', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.servicecontrol.v1'), createEmptyInstance: create)
    ...
    ..aOM<$29.Status>(3, _omitFieldNames ? '' : 'status', subBuilder: $29.Status.create)
  ...
  /// error.
  @$pb.TagNumber(3)
  $29.Status get status => $_getN(2);
  @$pb.TagNumber(3)
  set status($29.Status value) => $_setField(3, value);
  @$pb.TagNumber(3)
  $core.bool hasStatus() => $_has(2);
  @$pb.TagNumber(3)
  void clearStatus() => $_clearField(3);
  @$pb.TagNumber(3)
  $29.Status ensureStatus() => $_ensure(2);
