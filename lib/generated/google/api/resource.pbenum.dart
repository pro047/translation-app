...
class ResourceDescriptor_History extends $pb.ProtobufEnum {
  ...
  static final $core.List<ResourceDescriptor_History?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 2);
  static ResourceDescriptor_History? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class ResourceDescriptor_Style extends $pb.ProtobufEnum {
  ...
  static final $core.List<ResourceDescriptor_Style?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 1);
  static ResourceDescriptor_Style? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
