...
class Type_PrimitiveType extends $pb.ProtobufEnum {
  ...
  static final $core.List<Type_PrimitiveType?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 6);
  static Type_PrimitiveType? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class Type_WellKnownType extends $pb.ProtobufEnum {
  ...
  static final $core.List<Type_WellKnownType?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 3);
  static Type_WellKnownType? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
